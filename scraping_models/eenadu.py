...
class Eenadu:
    def scrape_website(self, url: str):
        ...
        with sync_playwright() as p:
            ...
            mongodb_client = MongoDBClient("eenadu", "eenadu_newspapers")
            for index in range(newspaper_len):
                ...
                for page_number in range(len(owl_items)):
                    ...
                    image_dict = image_dictionary(
                        image_src, date_published, page_number + 1, publication_name
                    )

                    image_dict2 = image_dictionary(
                        image_src2, date_published, page_number + 1, publication_name
                    )
